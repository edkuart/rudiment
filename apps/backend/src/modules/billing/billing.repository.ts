...
import { plans, subscriptions, payments, webhookEvents } from "../../shared/db/schema/index.js";
...
export class BillingRepository {
  ...
  async markWebhookEventProcessed(eventId: string, type: string): Promise<void> {
    await this.db
